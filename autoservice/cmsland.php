...
// Помощь
if(!isset($_GET['mode'])){
	echo('<div id="help"><p><br><h2>Админ панель</h2><p>Для заменты текста или картинок выберите страницу сайта и нажмите редактировать<p>Затем выберете что будете изменять, текст или картинки</div>');
};
